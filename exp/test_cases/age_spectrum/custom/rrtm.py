...
exp = Experiment(name = 'rampup_rrtm_continuation',ext_field_table=field_table_name, codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'do_rrtm_radiation': True,     #dont Use grey radiation
        'two_stream_gray' : False,  # Use RRTM
    ...
    'rrtm_radiation_nml': {
        ...
        'dt_rad': 14400, #Set RRTM radiation timestep to 3600 seconds, meaning it runs every 5 atmospheric timesteps        
    },
...
if __name__=="__main__":
    ...
    res_file = '/home/philbou/scratch/isca_data/rampup_rrtm/restarts/res0110.tar.gz'
    exp.run(112, use_restart=True, restart_file=res_file, num_cores=NCORES,overwrite_data=True)
    #exp.run(1, use_restart=False, num_cores=NCORES,overwrite_data=True)
    for i in range(113,241):
