...
exp = Experiment('55cnce_1bar_co_10-3co2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'co_mix_ratio': 0.9984294688749286,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 1e3,
...
if __name__=="__main__":
    ...
    exp.run(1591, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(1592, 1651):
