# Trappist-1b 
# pure co2 atmosphere
# compared to test3: better P grid
...
exp = Experiment('T1b_co2_test5', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b192_Trappist1_CO2_T42xP43_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b192_Trappist1_CO2_T42xP43_001_nk20'),
