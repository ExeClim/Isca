...
exp = Experiment('T1b_co2_test3', codebase=cb)
exp.clear_rundir()
...
diag.add_file('atmos_12_hourly', 12, 'hours', time_units='hours')
diag.add_file('atmos_3_hourly', 3, 'hours', time_units='hours')
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b192_Trappist1_CO2_T42xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b192_Trappist1_CO2_T42xP22_001_nk20'),
...
if __name__=="__main__":
    cb.compile()
    exp.run(31, num_cores=NCORES, overwrite_data=False)
    overwrite = False
