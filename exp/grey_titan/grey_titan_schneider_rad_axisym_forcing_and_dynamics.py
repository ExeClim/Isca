    ...
    for conv in conv_schemes:
        for depth_val in depths:
            for per_value in pers:
                exp = Experiment('grey_titan_T21_daily_tapio_rad_with_sponge_mk12_tau_diag_60_levels_axisym_forcing_and_dynamics', codebase=cb) #name of folder in which .nc files are output
                exp.clear_rundir()
