...
exp = Experiment('55cnce_1bar_co2_test', codebase=cb)
exp.clear_rundir()
...
diag = DiagTable()
diag.add_file('atmos_step', 1, 'seconds', time_units='seconds')
...
diag.add_field('atmosphere', 'rh', time_avg=False)
diag.add_field('mixed_layer', 't_surf', time_avg=False)
diag.add_field('mixed_layer', 'flux_t', time_avg=False) #SH
diag.add_field('mixed_layer', 'flux_lhe', time_avg=False) #LH
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b85_55CancriA_CO2_T62xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b85_55CancriA_CO2_T62xP22_001_nk20'),
        'dt_rad':dt_rad,
...
if __name__=="__main__":
    ...
    exp.run(11, num_cores=NCORES, overwrite_data=False)
    overwrite = False
