...
exp = Experiment('55cnce_10bar_co_0.5co2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'co_mix_ratio': 0.3889,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 0.5e6,
...
if __name__=="__main__":
    ...
    exp.run(1033, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(1034, 1034):
