# 55cnce_1bar-h2o_test1
# pure h2o atmosphere (cfc113)
# s0p0r0: default spec file + ps 1bar + T85
...
exp = Experiment('55cnce_1bar-h2o_test1', codebase=cb)
exp.clear_rundir()
...
diag = DiagTable()
diag.add_file('atmos_20min', 20, 'minutes', time_units='minutes')
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b170_55CancriA_H2O_T52xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b170_55CancriA_H2O_T52xP22_001_nk20'),
        'dt_rad':dt_rad,
        ...
        'co_mix_ratio':0.0, 'n2o_mix_ratio':0.0, 
        'ch4_mix_ratio':0.0, 'o2_mix_ratio':0.0, 
        'so2_mix_ratio':0.0, 'cfc11_mix_ratio':0.0,
        'cfc12_mix_ratio':0.0, 'hcfc22_mix_ratio':0.0,
        'hfc134a_mix_ratio':0.0, 'co2_ppmv': 0.0, 
        'cfc113_mix_ratio':1.0
    },
...
if __name__=="__main__":
    ...
    exp.run(33, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(34, 601):
