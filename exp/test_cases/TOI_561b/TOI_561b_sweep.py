...
diag = DiagTable()
diag.add_file('atmos_10period', 4000, 'minutes', time_units='minutes')
...
if __name__ == "__main__":
    ...
    albedo_list = [0]
    pressures_bar = [5]   # in bar
    lw_od = [4.8,8,16]
    lw_optical_depths = {1:1.6 ,3:4.8,5:8,10:16}  # mapping Ps -> tau
    ...
    for i in range(3):
        for a in albedo_list:
            od_lw = lw_od[i]   # get optical depth for given Ps
            run_exp = exp.derive(
                f"TOI_561b/Ab_0/Sensitivity_test1/TOI_561b_H2O_atm_lw_{od_lw}_5_bar_albedo_0",
            )
            ...
            run_exp.namelist['mixed_layer_nml']['albedo_value'] = 0
