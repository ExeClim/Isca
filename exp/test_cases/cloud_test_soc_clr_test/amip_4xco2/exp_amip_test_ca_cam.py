...
diag.add_field('cloud_simple', 'tot_cld_amt_cam', time_avg=True)
diag.add_field('cloud_simple', 'high_cld_amt_cam', time_avg=True)
diag.add_field('cloud_simple', 'mid_cld_amt_cam', time_avg=True)
diag.add_field('cloud_simple', 'low_cld_amt_cam', time_avg=True)
...
exp = Experiment('exp_soc_bucket_Park_temp_minus_5_40_radii_14_25_deep_conv_0p4mmday_clr_ice_zlcl_entrain_cam_ca_cfmin_0', codebase=cb)
...
exp.namelist = Namelist({
    ...
    'cloud_simple_nml': {
        ...
        'do_cam_cld_cover_diag': True, #### For CAM cloud cover diagnostics
