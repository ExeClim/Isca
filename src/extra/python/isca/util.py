...
def interpolate_output(infile, outfile, all_fields=True, var_names=[], p_levs = "input"):
    ...
    if isinstance(p_levs, str):
        ...
        elif p_levs.upper() == "OTHER":
            levels = [625, 615, 605, 595, 585, 575, 565, 555, 545, 535, 525, 515, 505, 495, 485, 475, 465, 455, 445, 435, 425, 420, 415, 410, 405, 400, 395, 390, 385, 380, 375, 350, 345, 340, 335, 330, 325, 320, 315, 310, 305, 300, 295, 290, 285, 280, 275, 250, 225, 200, 175, 150, 125, 100, 75, 50, 30, 20, 10, 1]
        else:
