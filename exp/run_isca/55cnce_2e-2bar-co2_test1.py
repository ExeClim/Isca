...
eccentricity = 0.05
## surface pressure
surface_pressure = 2.0e3 # [Pa] reference_sea_level_press
...
exp = Experiment('55cnce_2e-2bar-co2_test1', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b170_55CancriA_CO2_T52xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b170_55CancriA_CO2_T52xP22_001_nk20'),
        'dt_rad':dt_rad,
