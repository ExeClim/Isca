...
exp = Experiment('T1b_1bar-co2_tests3', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b63_Trappist-1_CO2_T42xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b63_Trappist-1_CO2_T42xP22_001_nk20'),
        'dt_rad':dt_rad,
