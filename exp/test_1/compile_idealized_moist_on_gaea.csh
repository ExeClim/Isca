...
set template  = $cwd/../../src/extra/mkmf.template.$platform  # path to template for your platform
set mkmf      = $cwd/../../src/extra/mkmf                     # path to executable mkmf
...
set dir_path = /scratch/sit204/FMS2013/GFDLmoistModel/src/extra/
#--------------------------------------------------------------------------------------------------------
