...
# pure co2 atmosphere
# s0p0r0: default spec file + ps 100bar + T85
...
eccentricity = 0.05
## surface pressure
surface_pressure = 1.0e7 # [Pa] reference_sea_level_press
...
exp = Experiment('55cnce_100bar-co2_test1', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
    ...
    exp.run(1672, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(1673, 1675):
