...
inputfiles = [os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'), os.path.join(base_dir,'input/sst_clim_amip_4k.nc'),
              os.path.join(GFDL_BASE,'input/land_masks/era_land_t42_filtered.nc'), os.path.join(base_dir, 'input/siconc_clim_amip.nc')]

#exp = Experiment('exp_soc_bucket_Park_temp_minus_5_40_radii_14_25_deep_conv_0p4mmday_clr_ice_4k', codebase=cb)
exp = Experiment('exp_soc_bucket_Park_temp_minus_5_40_radii_14_25_deep_conv_0p4mmday_clr_ice_4k_zlcl_entrain_surf_res_0p03', codebase=cb)
#exp = Experiment('exp_soc_bucket_Park_temp_minus_5_40_radii_14_25_clr_ice_4k_zlcl', codebase=cb)
...
exp.namelist = Namelist({
    ...
    'mixed_layer_nml': {
        ...
        'sst_file': 'sst_clim_amip_4k',            # Set name of sst input file
