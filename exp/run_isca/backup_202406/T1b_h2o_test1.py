...
exp = Experiment('T1b_h2o_test1', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b202_Trappist1_H2O_T42xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b202_Trappist1_H2O_T42xP22_001_nk20'),
        ...
        'inc_h2o': False, # set to True?
        'account_for_effect_of_water': False, # set to True?
