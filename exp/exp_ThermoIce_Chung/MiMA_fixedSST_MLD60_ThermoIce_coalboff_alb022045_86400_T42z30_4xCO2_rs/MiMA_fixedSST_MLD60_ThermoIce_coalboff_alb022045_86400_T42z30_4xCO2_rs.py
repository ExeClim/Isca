...
exp = Experiment('MiMA_fixedSST_MLD60_ThermoIce_coalboff_alb022045_86400_T42z30_4xCO2_rs', codebase=cb)
...
if __name__=="__main__":
    exp.run(738, use_restart=True , num_cores=NCORES )
#    exp.run(1, use_restart=True , num_cores=NCORES  ,restart_file ='/data/groups/feldl/pochung/Isca_out/MiMA_fixedSST_MLD60_ThermoIce_coalboff_alb022045_86400_T42z30_4xCO2_rs/CTL_res0840.tar.gz')
    for i in range(739,841):
