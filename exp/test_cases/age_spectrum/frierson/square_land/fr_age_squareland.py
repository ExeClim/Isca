...
exp = Experiment(name = 'fr_T42_4mom_square',ext_field_table=field_table_name, codebase=cb)

exp.inputfiles = ['./input/land_T42.nc']

#Tell model how to write diagnostics
diag = DiagTable()
diag.add_file('atmos_dt', 6, 'hours', time_units='days')
...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'land_file_name' : '/home/philbou/Isca/exp/test_cases/age_spectrum/frierson/square_land/input/land_T42.nc',   #Tell model where to find input file
