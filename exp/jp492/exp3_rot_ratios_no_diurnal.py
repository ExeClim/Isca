# Experiment 3
# Vary the rotation rate from Earth-like to tidally locked,
# Constant insolation p2(theta) i.e. do_seasonal is False
...
#for ratio in [360.0, 180.0, 90.0]:
#for ratio in [45.0, 30.0, 15.0]:
for ratio in [4.0, 2.0, 1.0]:
    exp = gfdl.experiment.Experiment('ratio_%d_no_cycle' % ratio)
    exp.clear_rundir()
