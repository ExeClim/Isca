...
exp = Experiment('frierson_MLD60_IceLock2MiMA_coalb2_alb022045_86400_tau2558_f02_T42z30_dt600_odp1155_rs', codebase=cb)
...
#        'albedo_value': 0.10,                  #Albedo value used            
        ...
        'ice_thickness_file':'/home/pochung/Isca/input/input_Chung/Ice/Ice_MiMActl_pen.nc', ### ### 2022/09/02
...
#        'sfc_melt_field':'t_surf_frictl_pen', ###
        ...
        ### fixed SST
        'do_sc_SST': False,
#        'sst_file_Chung' : '/home/pochung/Isca/input/input_Chung/t_surf/t_surf_frictl_pen.nc', ###
#        'sst_field_Chung': 't_surf_frictl_pen' ###
        ### fixed SST
    },
...
if __name__=="__main__":
    exp.run(113, use_restart=True , num_cores=NCORES )
#    exp.run(1, use_restart=True , num_cores=NCORES , restart_file ='/data/groups/feldl/pochung/Isca_out/frierson_MLD60_IceLock2MiMA_coalb2_alb022045_86400_tau2558_f02_T42z30_dt600_odp1155_rs/CTL_res0840.tar.gz')
    for i in range(114,841):
