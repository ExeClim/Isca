...
diag.add_field('dry_convection', 'CAPE', time_avg=True)
diag.add_field('dry_convection', 'CIN', time_avg=True)
diag.add_field('dry_convection', 'parcel_temp', time_avg=True)
diag.add_field('dry_convection', 'ambient_temp', time_avg=True)
diag.add_field('dry_convection', 'dt_tg', time_avg=True)
