...
sc_diag_name = 'eis_wood_dthdp'
#sc_diag_names = ['eis_wood_rh'] #'eis_wood_rh_base_gt_val'] #'ectei']#, 'eis_rh'] #'ectei_rh']#
#for sc_diag_name in sc_diag_names:
dthdp_min_arr = [-0.125, -0.2, -0.25]
for dthdp_min in dthdp_min_arr:
    exp = Experiment('soc_test_amip_linear_qcl_with_temp_sc_'+sc_diag_name+'_'+str(np.abs(dthdp_min)), codebase=cb)
