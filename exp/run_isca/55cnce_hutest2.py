# 55cnce_hutest2
# pure co2 atmosphere
# sp170 spec file + ps 0.06bar + T85
...
exp = Experiment('55cnce_hutest2', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
    ...
    exp.run(141, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(142, 401):
