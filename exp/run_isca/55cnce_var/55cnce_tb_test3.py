...
RESOLUTION = 'T85', 40
## atmosphere settings
kappa = 0.2778 # n_co2*9/2+n_co*7/2
...
exp = Experiment('55cnce_tb_test3', codebase=cb)
exp.clear_rundir()
