...
RESOLUTION = 'T42', 40
## atmosphere settings
kappa = 0.27777777777777773 # pure co
...
exp = Experiment('55cnce_0.1bar_n2_10-1co2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'hcfc22_mix_ratio': 0.8513513513513513,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 1e5, # ppmv:0~1e6
...
if __name__=="__main__":
    ...
    exp.run(483, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(484,501):
