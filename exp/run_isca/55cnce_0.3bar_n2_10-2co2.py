...
eccentricity = 0.05
## surface pressure
surface_pressure = 0.3e5 # [Pa] reference_sea_level_press
## timesteps (from grid/sound_speed 600s)
dt_rad = 5
dt_atmos = 1
RESOLUTION = 'T42', 40
## atmosphere settings
kappa = 0.28490028490028485 # pure co
mole_mass = 28.16e-3 # kg/mol
...
exp = Experiment('55cnce_0.3bar_n2_10-2co2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b110_co2-n2_55CancriA'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b110_co2-n2_55CancriA'),
        'dt_rad':dt_rad,
        ...
        'hcfc22_mix_ratio': 0.984375,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 1e4, # ppmv:0~1e6
        
        'n2o_mix_ratio':0.0,'ch4_mix_ratio':0.0,'o2_mix_ratio':0.0, 
        'so2_mix_ratio':0.0,'cfc11_mix_ratio':0.0, 'cfc12_mix_ratio':0.0, 
        'cfc113_mix_ratio':0.0,'co_mix_ratio':0.0,  
    },
...
if __name__=="__main__":
    ...
    exp.run(482, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(483, 501):
