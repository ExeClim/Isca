...
if __name__ == "__main__":
    ...
    albedo_list = [0.0]
    pressures_bar = [0.1]   # in bar
    lw_optical_depths = {0.1:0.057,1:0.57 ,3:1.70,5:2.84,10:5.67}  # mapping Ps -> tau
    sw_optical_depths = {0.1:0.0061,1:0.061, 3:0.184, 5:0.307, 10:0.613}
    M = 31.98
    Rd = 8.314 / M * 1e3
    Cp = 1181 
    gamma = Rd / Cp
    for Ps in pressures_bar:
        for a in albedo_list:
            ...
            run_exp = exp.derive(
                f"TOI_561b/Sw_exp10/O2_H2O_new_fits1/Clouds1/0.1_bar/TOI_561b_H2O_atm_lw_{od_lw}_sw_{od_sw}_{Ps}_bar_albedo_{a}"
            )
