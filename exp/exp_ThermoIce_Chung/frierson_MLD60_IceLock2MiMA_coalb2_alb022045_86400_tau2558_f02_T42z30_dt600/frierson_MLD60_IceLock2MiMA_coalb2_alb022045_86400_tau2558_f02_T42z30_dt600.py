...
exp = Experiment('frierson_MLD60_IceLock2MiMA_coalb2_alb022045_86400_tau2558_f02_T42z30_dt600', codebase=cb)
...
#        'sst_field_Chung': 't_surf_frictl_pen' ###
    ...
    'two_stream_gray_rad_nml': {
        ...
        ###
#        'odp' :1.17 , ### global warming <-- scaling factor to simulate 4xCO2
    },
...
if __name__=="__main__":
    exp.run(562, use_restart=True , num_cores=NCORES ,overwrite_data=True )
    for i in range(563,841):
