...
exp = Experiment('frierson_fixedSST2MiMA_MLD60_ThermoIce_coalb2_alb022045_86400_tau2558_f02_T42z30_dt600_ctl', codebase=cb)
...
#        'sfc_melt_field':'t_surf_frictl_pen', ###
    ...
    'two_stream_gray_rad_nml': {
        ...
        ###
#        'odp' :1.15 , ### global warming <-- scaling factor to simulate 4xCO2
    },
...
if __name__=="__main__":
    exp.run(118, use_restart=True , num_cores=NCORES )
    for i in range(119,841):
