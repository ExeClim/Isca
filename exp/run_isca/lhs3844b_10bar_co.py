...
exp = Experiment('lhs3844b_10bar_co', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b85_LHS3844_CO_T62xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b85_LHS3844_CO_T62xP22_001_nk20'),
        'dt_rad':dt_rad,
...
if __name__=="__main__":
    ...
    exp.run(601, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(602, 901):
