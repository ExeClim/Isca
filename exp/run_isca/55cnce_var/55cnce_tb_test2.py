...
RESOLUTION = 'T85', 40
## atmosphere settings
kappa = 0.2849 # n_co2*9/2+n_co*7/2
...
exp = Experiment('55cnce_tb_test2', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
    ...
    exp.run(51, num_cores=NCORES, overwrite_data=False)
    overwrite = False
