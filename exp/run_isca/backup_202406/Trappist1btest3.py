...
exp = Experiment('Trappist1btest3', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/ga7/sp_lw_ga7'), #check _k used in the file
...
if __name__=="__main__":
    cb.compile()
    exp.run(121, use_restart=True, num_cores=NCORES, overwrite_data=False)
    overwrite = False
