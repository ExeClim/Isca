...
RESOLUTION = 'T42', 40
## atmosphere settings
kappa = 0.26666666666666666 # R/cp
mole_mass = 40e-3 # kg/mol
...
exp = Experiment('55cnce_10bar_0.25co_0.25co2_0.5sio_110', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b110_cosi_55CancriA'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b110_cosi_55CancriA'),
        'dt_rad':dt_rad,
        ...
        'co_mix_ratio': 0.175,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 0.25e6,
        'hcfc22_mix_ratio':0.55, # SiO
