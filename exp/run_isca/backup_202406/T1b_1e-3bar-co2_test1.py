# T1b_1bar-co2_test1
# pure co2 atmosphere
# s0p0r0: default spec file + ps 1bar + T42
...
## timesteps (from grid/sound_speed 1280s)
dt_rad = 100
dt_atmos = 20
## atmosphere settings
kappa = 2./9. # pure co2
...
exp = Experiment('T1b_1e-3bar-co2_test1', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b106_Trappist-1_CO2_T42xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b106_Trappist-1_CO2_T42xP22_001_nk20'),
        'dt_rad':dt_rad,
...
if __name__=="__main__":
    cb.compile()
    exp.run(204, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(205, 241):
