...
eccentricity = 0.05
## surface pressure
surface_pressure = 1e5 # [Pa] reference_sea_level_press
...
exp = Experiment('55cnce_1bar_n2', codebase=cb) # n2 is HCFC22
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b85_co2-n2_55CancriA'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b85_co2-n2_55CancriA'),
        'dt_rad':dt_rad,
        ...
        'inc_h2o': False,
        'inc_co2': True,
        'inc_hcfc22': True, # cheating gas for n2
        ...
        'account_for_effect_of_ozone': False,
          #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 0.0, # ppmv:0~1e6
        'hcfc22_mix_ratio':1.0, # cheating gas for n2
...
if __name__=="__main__":
    ...
    exp.run(879, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(880, 1201):
