# 55cnce_hutest2
# co + co2 atmosphere
# sp85 spec file + ps 17.26bar + T85
...
eccentricity = 0.05
## surface pressure
surface_pressure = 10e5 # [Pa] reference_sea_level_press
## timesteps (from grid/sound_speed 600s)
dt_rad = 10
dt_atmos = 2
RESOLUTION = 'T85', 51
## atmosphere settings
kappa = 0.2856653145175112 # n_co2*9/2+n_co*7/2
mole_mass = 28.0096e-3 # kg/mol
...
exp = Experiment('55cnce_tb_test4', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b88_co2-co_55CancriA'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b88_co2-co_55CancriA'),
        'dt_rad':dt_rad,
    ...
    'spectral_dynamics_nml': {
        'damping_order': 4,
        'damping_coeff': 2.3148148e-03,      
        'water_correction_limit': 200.e2,
        'reference_sea_level_press':surface_pressure,
        'num_levels':51,      #How many model pressure levels to use
