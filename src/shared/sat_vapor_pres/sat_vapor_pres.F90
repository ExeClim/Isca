...
! </PUBLIC>
 ...
 use         constants_mod, only:  TFREEZE, TFREEZE_WATER, RDGAS, RVGAS, HLV, ES0, triple_point_pres
...
!----------------------------------------------------------------------- 
  ...
  nlim  = nsize-1
  call sat_vapor_pres_init_k(nsize, real(tcmin), real(tcmax), TFREEZE, TFREEZE_WATER, HLV, &
                             RVGAS, ES0, triple_point_pres, err_msg_local, use_exact_qs, do_simple, &
                             construct_table_wrt_liq, &
                             construct_table_wrt_liq_and_ice, &
                             teps, tmin, dtinv)
