...
exp = Experiment('55cnce_1bar-co2_test1', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b106_55CancriA_CO2_T52xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b106_55CancriA_CO2_T52xP22_001_nk20'),
        'dt_rad':dt_rad,
        ...
        'hfc134a_mix_ratio':0.0, 'cfc113_mix_ratio':0.0,
    },
    
    'spectral_init_cond_nml': {
        'initial_temperature': 2500 # < min T
    },
...
if __name__=="__main__":
    ...
    exp.run(560, num_cores=NCORES, overwrite_data=False)
    overwrite = False
