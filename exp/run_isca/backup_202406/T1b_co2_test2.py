# Trappist-1b
# pure co2 atmosphere
# shortwave b202, longwave b202 --> why 202 & 40 doesn't work?
...
exp = Experiment('T1b_co2_test2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_lw_b40_Trappist1_CO2_UCL_T41xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_sw_b112_Trappist1_CO2_UCL_T41xP22_001_nk20'),
