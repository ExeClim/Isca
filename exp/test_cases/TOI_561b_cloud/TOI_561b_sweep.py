...
if __name__ == "__main__":
    ...
    for Ps in pressures_bar:
        for a in albedo_list:
            ...
            run_exp = exp.derive(
                f"TOI_561b/Diff_ocean_depths/TOI_561b_H2O_atm_lw_{od_lw}_{Ps}_bar_albedo_0_depth_{a}m",
            )
            ...
            run_exp.namelist['mixed_layer_nml']['depth'] = a
