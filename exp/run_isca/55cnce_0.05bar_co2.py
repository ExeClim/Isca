...
eccentricity = 0.05
## surface pressure
surface_pressure = 0.05e5 # [Pa] reference_sea_level_press
...
exp = Experiment('55cnce_0.05bar_co2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'damping_driver_nml': {
        'do_rayleigh': True,
        'trayfric': -50/86400,              # neg. value: time in *days*
        'sponge_pbottom':  100., #Setting the lower pressure boundary for the model sponge layer in Pa.
...
if __name__=="__main__":
    ...
    exp.run(14, num_cores=NCORES, overwrite_data=False)
    overwrite = False
