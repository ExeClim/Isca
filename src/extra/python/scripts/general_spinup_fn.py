...
def q_spinup(run_fol, var_to_integrate, start_month, end_month, plt_dir):
    ...
    #data directory
    data_dir = '/scratch/sit204/mounts/gv3/sit204/Data_2013/giant_planet/'
    #file name
...
if __name__ == "__main__":
	...
	start_month_arr=[1,1,1,1]
	end_month_arr=[488,488,488,488]
	...
	variable_to_integrate='ucomp_sq'
