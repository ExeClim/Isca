...
exp = Experiment('Trappist1btestb200', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_lw_b200_Trappist1_CO2_UCL-4000_1.0-20000.0_T49xP22_001_nk20'), #check _k used in the file
        'sw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_sw_b200_Trappist1_CO2_UCL-4000_1.0-20000.0_T49xP22_001_nk20'),
