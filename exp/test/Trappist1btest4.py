...
exp = Experiment('Trappist1btest4', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_lw_b5_Trappist1'), #check _k used in the file
        'sw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_sw_b5_Trappist1'),
        'dt_rad':3600,
...
if __name__=="__main__":
    cb.compile()
    exp.run(1, use_restart=True, num_cores=NCORES, overwrite_data=False)
    overwrite = False
