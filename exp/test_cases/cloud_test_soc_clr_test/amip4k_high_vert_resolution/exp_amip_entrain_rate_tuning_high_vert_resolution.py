...
## Add some tendency diagnositcs
# temperature
diag.add_field('atmosphere', 'dt_tg_convection', time_avg=True)
diag.add_field('atmosphere', 'dt_tg_diffusion', time_avg=True) # if turb is True, units K/s
...
diag.add_field('atmosphere', 'dt_qg_condensation', time_avg=True) # 'kg/kg/s'

# moist/dry static energy s=c_p*T+gz+(Lv*q)
...
#exp = Experiment('exp_soc_bucket_Park_temp_minus_5_40_radii_14_25_deep_conv_0p4mmday_clr_ice_zlcl_entrain_0p8_surf_res_0p03', codebase=cb)
#exp = Experiment('exp_soc_bucket_Park_temp_minus_5_40_radii_14_25_deep_conv_0p4mmday_clr_ice_zlcl_entrain_0p1_surf_res_0p03', codebase=cb)
exp = Experiment('exp_soc_bucket_Park_temp_minus_5_40_radii_14_25_deep_conv_0p4mmday_clr_ice_zlcl_entrain_0p5_surf_res_0p03', codebase=cb)

#exp = Experiment('exp_soc_bucket_Park_temp_minus_5_40_radii_14_25_deep_conv_0p4mmday_clr_ice', codebase=cb)
#exp = Experiment('exp_soc_bucket_Park_temp_minus_5_40_radii_14_25_clr_ice_zlcl', codebase=cb)
...
exp.namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        ...
        'surf_res': 0.03, #0.1, #0.2, #Parameter that sets the vertical distribution of sigma levels
        'scale_heights': 11.0,
        'exponent': 7.0,
        'robert_coeff': 0.03,
