...
RESOLUTION = 'T42', 40
## atmosphere settings
kappa = 0.285706122682209 # 
mole_mass = 28.0016e-3 # kg/mol
...
exp = Experiment('55cnce_10bar_n2_10-4co2_110', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'hcfc22_mix_ratio': 0.9998428661219358,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 1e2,
