...
exp = Experiment('Trappist1btest7_2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_lw_b31_Trappist1_Voi-Fnorm_UCL-4000'), #check _k used in the file
        'sw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_sw_b31_Trappist1_Voi-Fnorm_UCL-4000'),
...
if __name__=="__main__":
    cb.compile()
    exp.run(23, num_cores=NCORES, overwrite_data=False)
    overwrite = False
