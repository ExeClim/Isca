...
exp = Experiment('55cnce_0.1bar_co2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b110_co2-co_55CancriA'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b110_co2-co_55CancriA'),
        'dt_rad':dt_rad,
    ...
    'damping_driver_nml': {
        'do_rayleigh': True,
        'trayfric': -100/86400,              # neg. value: time in *days*
...
if __name__=="__main__":
    ...
    exp.run(150, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(151, 175):
