...
RESOLUTION = 'T42', 40
## atmosphere settings
kappa = 0.28563267637817763 # 
mole_mass = 28.016e-3 # kg/mol
...
exp = Experiment('55cnce_1bar_n2_10-3co2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'hcfc22_mix_ratio': 0.9984294688749286,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 1e3,
...
if __name__=="__main__":
    ...
    exp.run(1492, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(1493, 1501):
