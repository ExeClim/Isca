...
namelist = Namelist({
    ...
    'damping_driver_nml': {
        ...
        'sponge_pbottom':  1.1205,           #Bottom of the model's sponge down to 1.1205 for 3 model layers (was previously 50hPa) (units are Pa)
...
#     },
    ...
    'spectral_init_cond_nml': { #additional to the Mars script
        'initial_temperature': 150.
    },

    'astronomy_nml': { #Titan Values
    ...
    'constants_nml': { #Titan Values
        'orbital_period': 928523294,  #value calculated from Stephen's day/year calculator script
        'solar_const':15.078, 
        'radius':2575.0e3,
        'rdgas':290,
        'kappa':0.2727, #these values from Planetary Atmospheres (2015)
        'rotation_period':1377631, #value calculated from Stephen's day/year calculator script
    },
    ...
    for conv in conv_schemes:
        for depth_val in depths:
            for per_value in pers:
                ...
                exp.namelist['constants_nml']['grav']     = scale * 1.354 #From A. Coustenis Book
