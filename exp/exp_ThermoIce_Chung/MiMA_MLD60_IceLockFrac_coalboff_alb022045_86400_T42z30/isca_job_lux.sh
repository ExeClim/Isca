#!/bin/bash
#SBATCH --job-name=MiMA_MLD60_IceLockFrac_coalboff_alb022045_86400_T42z30 # Job name
...
python $GFDL_BASE/exp/exp_ThermoIce_Chung/MiMA_MLD60_IceLockFrac_coalboff_alb022045_86400_T42z30/MiMA_MLD60_IceLockFrac_coalboff_alb022045_86400_T42z30.py
