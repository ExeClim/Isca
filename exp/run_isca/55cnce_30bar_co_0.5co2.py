...
eccentricity = 0.05
## surface pressure
surface_pressure = 30e5 # [Pa] reference_sea_level_press
...
exp = Experiment('55cnce_30bar_co_0.5co2', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
    ...
    exp.run(789, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(790, 790):
