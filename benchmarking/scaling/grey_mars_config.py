from isca import GreyCodeBase, DiagTable, Namelist, GFDL_BASE
...
def setup_grey_mars_namelist():
    ...
    namelist['spectral_dynamics_nml']['reference_sea_level_press'] = scale * 610.0
