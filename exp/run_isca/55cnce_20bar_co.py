...
eccentricity = 0.05
## surface pressure
surface_pressure = 20e5 # [Pa] reference_sea_level_press
...
exp = Experiment('55cnce_20bar_co', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
    ...
    exp.run(3601, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(3602, 4801):
