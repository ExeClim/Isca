...
exp = Experiment('MiMA_MLD60_IceLockFrac_coalboff_alb022045_86400_T42z30_4xCO2_rs', codebase=cb)
...
#        'albedo_value': 0.1,
        ...
        ### fixed sea ice
        'do_thickness_lock':False,        ### Chung:active thermodynamic ice thickness lock
...
if __name__=="__main__":
    exp.run(633, use_restart=True , num_cores=NCORES ,overwrite_data=True)
#    exp.run(1, use_restart=True , restart_file='/data/groups/feldl/pochung/Isca_out/MiMA_MLD60_IceLockFrac_coalboff_alb022045_86400_T42z30_4xCO2_rs/CTL_res0840.tar.gz' , num_cores=NCORES ,overwrite_data=True)
    for i in range(634,841):
