...
eccentricity = 0.05
## surface pressure
surface_pressure = 17.26e5 # [Pa] reference_sea_level_press
...
exp = Experiment('55cnce_hutest1', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b85_co2-co_55CancriA'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b85_co2-co_55CancriA'),
        'dt_rad':dt_rad,
...
if __name__=="__main__":
    ...
    exp.run(227, num_cores=NCORES, overwrite_data=False)
    overwrite = False
    for i in range(228, 801):
