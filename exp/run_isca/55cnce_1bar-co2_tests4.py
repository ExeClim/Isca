...
exp = Experiment('55cnce_1bar-co2_tests4', codebase=cb)
exp.clear_rundir()
...
diag = DiagTable()
diag.add_file('atmos_2hour', 120, 'minutes', time_units='minutes')
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b85_55CancriA_CO2_T52xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b85_55CancriA_CO2_T52xP22_001_nk20'),
        'dt_rad':dt_rad,
...
if __name__=="__main__":
    ...
    exp.run(305, num_cores=NCORES, overwrite_data=False)
    overwrite = False
