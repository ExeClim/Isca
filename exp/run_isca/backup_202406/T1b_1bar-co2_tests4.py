...
exp = Experiment('T1b_1bar-co2_tests4', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b106_Trappist-1_CO2_T57xP43_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b106_Trappist-1_CO2_T57xP43_001_nk20'),
        'dt_rad':dt_rad,
...
if __name__=="__main__":
    cb.compile()
    exp.run(10, num_cores=NCORES, overwrite_data=False)
    overwrite = False
