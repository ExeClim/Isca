...
exp = Experiment('T1b_h2o_test2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    'main_nml':{
     ...
     'minutes': 0,
     'seconds': 0,
     'dt_atmos':120,  # default: 600, to avoid negative T
     'current_date' : [1,1,1,0,0,0],
     'calendar' : 'thirty_day'
    },
    'socrates_rad_nml': {
        'stellar_constant':S0*1370,
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b121_Trappist1_H2O_T42xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b121_Trappist1_H2O_T42xP22_001_nk20'),
        ...
        'inc_co2':False,
        'inc_co': False,
        'account_for_effect_of_water': True, # if False then radiation is fed water mixing ratios = 0. If true it's fed mixing ratios based on model specific humidity.
    ...
    'qe_moist_convection_nml': {
        'rhbm':0.7,
        'Tmin':160.,
        'Tmax':373.   # can't be more than 373K ?
    },
