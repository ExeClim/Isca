...
exp = Experiment('Trappist1btest2', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_lw_b297_12C-16O_010_Trappist1'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_sw_b297_12C-16O_010_Trappist1'),
        'dt_rad':3600,
    ...
    'constants_nml': {
        ...
        'rdgas': 188.95, # gas constant for dry air [J/kg/K]
    },
