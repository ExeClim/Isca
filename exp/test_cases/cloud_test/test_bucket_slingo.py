...
for sc_diag_name in sc_diag_names:
    print(sc_diag_name)
    exp = Experiment('soc_test_bucket_slingo_lev_surfres_0.1_adj_low', codebase=cb)
    exp.clear_rundir()
    ...
    exp.namelist = Namelist({
        ...
        'spectral_dynamics_nml': {
            ...
            'surf_res': 0.1, #0.03, # #Parameter that sets the vertical distribution of sigma levels
            'scale_heights': 11.0,
            'exponent': 7.0,
            'robert_coeff': 0.03,
