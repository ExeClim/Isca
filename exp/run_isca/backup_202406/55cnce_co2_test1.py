...
exp = Experiment('55cnce_co2_test1', codebase=cb)
exp.clear_rundir()
...
diag = DiagTable()
diag.add_file('atmos_3day', 3, 'days', time_units='days')
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b192_55CancriA_CO2_T42xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b192_55CancriA_CO2_T42xP22_001_nk20'),
        'dt_rad':10,    # 60 crash
