...
exp = Experiment('gj486b_10bar_co', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b85_GJ486_CO_T62xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b85_GJ486_CO_T62xP22_001_nk20'),
        'dt_rad':dt_rad,
        ...
        'co_mix_ratio': 1.0,  #  mixed gas concentrations (kg / kg)
        'co2_ppmv': 0.0,
