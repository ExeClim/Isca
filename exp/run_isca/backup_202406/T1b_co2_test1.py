...
exp = Experiment('T1b_co2_test1', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'sw_spectral_filename':os.path.join(GFDL_BASE,'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/sp_sw_b202_Trappist1_CO2_UCL_T41xP22_001_nk20'),
        ...
        'inc_h2o': False, # there are many gases to include
