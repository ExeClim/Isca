...
if __name__ == "__main__":
    ...
    for i in range(len(frac_list)):
            run_exp = exp.derive(
                f"TOI_561b/Ab_0/Diff_frac_2/TOI_561b_CO2_atm_lw_1.6_1_bar_frac_{frac_list[i]}"
            )
            ...
            run_exp.namelist['two_stream_gray_rad_nml']['ir_tau_eq'] = 1.6
            run_exp.namelist['two_stream_gray_rad_nml']['ir_tau_pole'] = 1.6
            run_exp.namelist['constants_nml']['rdgas'] = Rd
            run_exp.namelist['constants_nml']['kappa'] = gamma
            run_exp.namelist['diffusivity_nml']['tj_bl_pres'] = 85000. * 1
            run_exp.namelist['diffusivity_nml']['tj_strato_pres'] = 10000. / 2. * 1
            run_exp.namelist['damping_driver_nml']['sponge_pbottom'] = 260. * 1
            run_exp.namelist['diffusivity_nml']['tj_coeff'] = frac_list[i]
            run_exp.namelist['diffusivity_nml']['tj_coeff_m'] = frac_list[i]
