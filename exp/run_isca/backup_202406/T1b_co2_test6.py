# Trappist-1b  
# pure co2 atmosphere
# test6: compared to test3: better wn
...
exp = Experiment('T1b_co2_test6', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b384_Trappist1_CO2_T42xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b384_Trappist1_CO2_T42xP22_001_nk20'),
