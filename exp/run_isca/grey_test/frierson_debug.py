...
exp = Experiment('frierson_debug', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'convection_scheme': 'DRY',#'SIMPLE_BETTS_MILLER', #Use the simple Betts Miller convection scheme from Frierson
    },
    ...
    'constants_nml': {
        ...
        'solar_const':1*1370., # [W/m^2]
        'rdgas': 2/7, # gas constant for N2 [J/kg/K]
        'kappa': 8.314/28e-3 # R/c_p depends on the molecule
    },
})
