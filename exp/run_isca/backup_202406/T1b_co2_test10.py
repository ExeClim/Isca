...
surface_pressure = 1.0e2 # [Pa] reference_sea_level_press
import os
import numpy as np
...
exp = Experiment('T1b_co2_test10', codebase=cb)
exp.clear_rundir()
...
#
sp_test_root = 'src/atmos_param/socrates/src/trunk/data/spectra/sp_test/old/backup_202406'
star_gas = 'Trappist1/CO2'
...
exp.namelist = namelist = Namelist({
    'main_nml':{
     ...
     'minutes': 0,
     'seconds': 0,
     'dt_atmos':15,  # default: 600
     'current_date' : [1,1,1,0,0,0],
     'calendar' : 'thirty_day'
    },
    'socrates_rad_nml': {
        'stellar_constant':S0*1370,
        'lw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_lw_b78_Trappist1_CO2_T42xP22_001_nk20'),
        'sw_spectral_filename':os.path.join(GFDL_BASE,sp_test_root,star_gas,'sp_sw_b78_Trappist1_CO2_T42xP22_001_nk20'),
        'dt_rad':30,    # P=1.5 day dtrad=1day???
...
if __name__=="__main__":
    cb.compile()
    exp.run(30, num_cores=NCORES, overwrite_data=False)
    overwrite = False
