...
exp = Experiment('MiMA_MLD60_IceLockFrac_coalboff_alb022045_86400_T42z30', codebase=cb)
...
if __name__=="__main__":
    exp.run(639, use_restart=True , num_cores=NCORES , overwrite_data=True )
    for i in range(640,841):
