...
for sc_diag_name in sc_diag_names:
    print(sc_diag_name)
    #exp = Experiment('exp_soc_bucket_linear_Park_ajd_cf_0_marine_sc_omega_0.4hPa_h', codebase=cb)
    #exp = Experiment('exp_soc_bucket_linear_Park_ajd_cf_0_marine_sc_omega_0.4hPa_h_kk_kb', codebase=cb)
    #exp = Experiment('exp_soc_bucket_linear_Park_elfab_test_ca', codebase=cb)
    #exp = Experiment('exp_soc_bucket_linear_Park_elfab_test_ca_no_adj', codebase=cb)
    exp = Experiment('exp_soc_bucket_linear_Park_elfab_test_ca_dthdpmin_0.08_noadj_kk', codebase=cb)
    exp.clear_rundir()
    ...
    exp.namelist = Namelist({
        ...
        'cloud_simple_nml': {
            ...
            'omega_adj_threshold': -0.01,
            'do_qcl_with_temp': True,
            'do_cloud_amount_diags': True,
            'do_add_stratocumulus': True, #False,
