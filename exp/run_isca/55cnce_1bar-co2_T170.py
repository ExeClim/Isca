...
exp = Experiment('55cnce_1bar-co2_T170', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'fms_nml': {
        'domains_stack_size': 1200000                        # default: 0
    },
...
if __name__=="__main__":
    ...
    exp.run(99, num_cores=NCORES, overwrite_data=False)
    overwrite = False
