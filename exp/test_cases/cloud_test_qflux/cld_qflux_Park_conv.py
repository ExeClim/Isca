...
#exp = Experiment('cld_Park_qflux_kk', codebase=cb)
#exp = Experiment('cld_Park_qflux_conv_kk_test', codebase=cb)
#exp = Experiment('cld_Park_qflux_south_ocean_kk_kb_conv', codebase=cb)
#exp = Experiment('cld_Park_qflux_kk_kb_conv_gv1', codebase=cb)
#exp = Experiment('cld_Park_qflux_kk_m1_kb_conv_gv1', codebase=cb)
exp = Experiment('cld_Park_qflux_kk_m1_kb_conv_so_gv1', codebase=cb)

exp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42_filtered.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),
...
exp.namelist = Namelist({
    ...
    'mixed_layer_nml': {
        ...
        'qflux_file_name' : 'ami_qflux_ctrl_ice_4320', #Name of q-flux
    },
